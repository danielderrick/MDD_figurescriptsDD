...
#Compare this clustering to the seed42 clustering
multiomics_14_single_seed_features_data_mean<- read_csv(paste0(data_path, "MDD_combined14_mean_seed42.csv"))
multiomics_14_single_seed_features_data_mean_dm <- multiomics_14_single_seed_features_data_mean %>%
  select(-Cluster) %>%
  as.matrix()
rownames(multiomics_14_single_seed_features_data_mean_dm) <- multiomics_14_single_seed_features_data_mean$Cluster
single_seed_to_consensus_cors <- cor(t(multiomics_14_features_data_mean_dm), t(multiomics_14_single_seed_features_data_mean_dm), method = "pearson")

hm_single_seed_to_consensus_cors <- Heatmap(single_seed_to_consensus_cors, 
                                            column_title = "single seed to consensus clustering correlations",
                                            name = "pearson\ncorrelations ",
                                            row_names_gp = gpar(fontsize = 5),
                                            column_names_gp = gpar(fontsize = 5),
                                            col = colorRamp2(c(-1, 0, 1), c("#2166AC", "white", "#B2182B")))
hm_single_seed_to_consensus_cors
#Remove the cluster assignments to keep the code similar to the 
#other dataset processing
...
if(create_pdfs){
 ...
 draw(hm_multiomics_14)
  ...
  draw(hm_single_seed_to_consensus_cors)
  res <- dev.off()
} 
