...
haLeft = rowAnnotation(foo = anno_mark(at = RPPA_motif_rows_right,
                                   labels = df$feature[RPPA_motif_rows_right],
                                   labels_gp = gpar(fontsize = 5)))
...
cluster2_single <- multiomics_combined14_single %>%
  filter(Cluster == "2")
cluster4_consensus <- multiomics_14_features_data_ann %>%
  filter(Cluster == "4")
...
multiomics_14_features_data_ann_4_10 <- multiomics_14_features_data_ann %>%
...
clustering_module_comparisons <- multiomics_combined14_single_2_9 %>%
 full_join(multiomics_14_features_data_ann_4_10, by = "feature_type") %>%
...
#####
if(create_pdfs){
  pdf("../plots/MDD_multiomics_heatmaps.pdf",height = 10) 
