...
multiomics_14_GTEx <- read_delim("../multiomics_analysis/data/GTEx_Analysis_2017-06-05_v8_RNASeQCv1.1.9_gene_median_tpm.gct", 
...
if(write_csvs){
  write_csv( multiomics_14_GTEx_mean, file = "../multiomics_analysis/tables/Sup Table 10 GTEx_heatmap.csv")
}
