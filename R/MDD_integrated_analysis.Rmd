...
if(create_pdfs) {
  pdf("../multiomics_analysis/plots/MDD_F5d.pdf")
  res <- print(p_mod10_edu)
  res <- dev.off()
  pdf("../multiomics_analysis/plots/MDD_F5e.pdf")
  res <- print(p_mod9_18_mcc)
  res <- dev.off() 
  pdf("../multiomics_analysis/plots/MDD_F5f.pdf")
  res <- print(p_mod7_mcc)
  res <- dev.off() 
  pdf("../multiomics_analysis/plots/MDD_F5g.pdf")
...
if(create_pdfs){
  pdf("../multiomics_analysis/plots/MDD_SFc.pdf")
